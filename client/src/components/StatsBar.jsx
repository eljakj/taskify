export default function StatsBar({ total, active, completed, overdue }) {
  const cards = [
    ...
    },
    {
      ...
      value: active,
      className:
        "border-sky-200 bg-sky-200 text-sky-700 dark:border-sky-500/20 dark:bg-sky-500/20 dark:text-sky-300",
    },
    {
      label: "Completed",
      value: completed,
      className:
        "border-emerald-200 bg-emerald-200 text-emerald-700 dark:border-emerald-500/20 dark:bg-emerald-500/20 dark:text-emerald-300",
    },
    {
      label: "Overdue",
      value: overdue,
      className:
        "border-red-200 bg-red-200 text-red-700 dark:border-red-500/20 dark:bg-red-500/20 dark:text-red-300",
    },
  ];
  ...
  return (
    <div className="mb-4 grid grid-cols-2 gap-2 sm:mb-5 sm:gap-2.5 lg:grid-cols-4">
      {cards.map((card) => (
        ...
        >
          <p className="text-[10px] font-medium uppercase sm:text-[11px]">
            {card.label}
          </p>
